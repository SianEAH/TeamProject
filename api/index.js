...
const connectDB = require('./_internal/db');
...
app.use('/api/login', require('./_internal/routes/login'));
app.use('/api/user', require('./_internal/routes/user'));
app.use('/api/puzzles', require('./_internal/routes/puzzles'));
